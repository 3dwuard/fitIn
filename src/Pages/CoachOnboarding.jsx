  ...
  return (
    <main style={{ margin: '0 auto', padding: '48px 24px', width: '100%', maxWidth: '480px' }}>
      ...
      <div style={{ marginBottom: '32px' }}>
        ...
        <p style={{ fontSize: '14px', color: '#6B6B6B' }}>Tell athletes about your experience</p>
      </div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
        ...
        <div>
          <label style={{ fontSize: '13px', fontWeight: '500', color: '#0A0A0A', display: 'block', marginBottom: '6px' }}>About you</label>
          <textarea
            placeholder="Describe your coaching experience, specialties and achievements..."
            value={bio}
